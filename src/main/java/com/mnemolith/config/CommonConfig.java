...
public final class CommonConfig {
    ...
    static {
        ...
        ALLOW_AMBIENT_PRESSURE = SpecValues.bool(builder, "allowAmbientPressure", "Whether the server may send nearby pressure snapshots to a player who is not holding a chronicle lens. Vein marks stay lens-only. The client visuals.ambientWithoutLens toggle only draws that shimmer; it cannot grant the snapshot by itself.", false);
