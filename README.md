...
6. Craft a **catalog fragment** (paper, amethyst shard, and ink sac, stacked) and use it to open the tags and patterns you have already learned. An observatory chest can also hold one. The screen shows only what that player has already discovered.
