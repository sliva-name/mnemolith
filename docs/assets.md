...
| `textures/gui/guide/*.png` | 256×128 | Twenty-one original panels (`recording.png` and `grafts.png` are generated by `tools/art/graft_art.py` in the same style) (ink `#1C244A`, bone `#E6DCC8`, verdigris `#8ED9C8`, fail `#FFB089`) for the field-guide pages |
